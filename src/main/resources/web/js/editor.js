    ...
    $.when(retrievedScheduleDeferred, vrtxEditor.multipleFieldsBoxesDeferred).done(function() {
      ...
      var formatMonth = function(m) {
        switch(m) {
          ...
          case "05": return (vrtxAdmin.lang == "en") ? "may" : "mai"; break;
          case "06": return "jun";                                    break;
          case "07": return "jul";                                    break;
          case "08": return "aug";                                    break;
          case "09": return "sept";                                   break;
          case "10": return (vrtxAdmin.lang == "en") ? "oct" : "okt"; break;
          case "11": return (vrtxAdmin.lang == "en") ? "nov" : "nov"; break;
          case "12": return (vrtxAdmin.lang == "en") ? "dec" : "des"; break;
          default: break;
        }
      };
      
      var formatDate = function(s, e) {
        /* IE8 doesn't parse Date based on timestamp:
         *   http://www.digital-portfolio.net/blog/view/ie8-and-iso-date-format */
        var sd = s.split("T")[0].split("-");
        var st = s.split("T")[1].split(".")[0].split(":");
        var et = e.split("T")[1].split(".")[0].split(":");
        return sd[2] + ". " + formatMonth(sd[1]) + " " + sd[0] + " - kl " +
               st[0] + ":" + st[1] + "&ndash;" +
               et[0] + ":" + et[1];
      };
