...
var baseURL = '/vrtx/__vrtx/kupu-dist-resources/common/';
...
function LinkTool() {
    ...
    this.createLinkHandler = function(event) {
        ...
        if( is_ie )
        	var linkWindow = openPopup(baseURL+'kupupopups/link.html', 300, 200);
        else
...
function ImageTool() {
    ...
    this.createImageHandler = function(event) {
        ...
        if( is_ie )
        	var imageWindow = openPopup(baseURL+'kupupopups/image.html', 300, 200);
        else
