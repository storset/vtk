    ...
    <#if page == 1>
     ...
     <#elseif searchComponents?has_content>
       <#if collection.resourceType = 'article-listing'>
         <@articles.displayArticles page=page collectionListings=searchComponents numberOfColumns=numberOfColumns hideNumberOfComments=hideNumberOfComments displayMoreURLs=true />
       <#else>
