...
package org.osmf.net
{
	...
	public class PlaybackOptimizationManager
	{
		 ...
		 */ 
		public function optimizePlayback(netStream:NetStream, dsResource:DynamicStreamingResource):void
		{
			...
			{
				if (configuration.optimizeBuffering && configuration.dynamicStreamBufferTime > 0)
				{
					netStream.bufferTime = configuration.dynamicStreamBufferTime;
				}
		...
		protected function updateInitialIndex(dsResource:DynamicStreamingResource, averageDownloadBytesPerSecond:Number):void
		{
			...
			var downloadBitrate:Number =  averageDownloadBytesPerSecond / PlaybackOptimizationMetrics.KBITSPS_BYTESTPS_RATIO
