...
<#macro addDatePickerScripts oldEditor=false>
  ...
  <script type="text/javascript" src="${webResources?html}/jquery/ui/plugins/jquery-ui-1.8.8.custom/js/jquery-ui-1.8.8.custom.min.js"></script>
  <script type="text/javascript" src="${webResources?html}/jquery/ui/plugins/jquery-ui-1.8.8.custom/js/jquery.ui.datepicker-no.js"></script>
  <script type="text/javascript" src="${webResources?html}/jquery/ui/plugins/jquery-ui-1.8.8.custom/js/jquery.ui.datepicker-nn.js"></script>
  <#if oldEditor>
