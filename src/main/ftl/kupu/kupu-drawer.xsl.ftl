        ...
        <html lang="en" xml:lang="en" xmlns="http://www.w3.org/1999/xhtml">
            <head>
                ...
                <link type="text/css" rel="stylesheet">
                    <xsl:attribute name="href">${drawerStylesURL}</xsl:attribute>
                </link>
            </head>
            <body>
...
<!--
     Modified by gormap: (see following URLs:)
     http://codespeak.net/pipermail/kupu-dev/2005-September/001547.html
     http://codespeak.net/pipermail/kupu-dev/2005-September/001553.htlm
-->
        <iframe id="kupu-upload-form-target" name="kupu_upload_form_target"
                src="${kupuBase}/common/kupublank.html" scrolling="off" frameborder="0" width="0px" height="0px" display="None">
        </iframe>
      </div>
    </xsl:template>
