 ...
 *  TODO: http://net.tutsplus.com/tutorials/javascript-ajax/wrangle-async-tasks-with-jquery-promises/
 *
 *  ToC: 
 *
 *  1.  Config
  ...
  if(typeof vrtxImageEditor !== "undefined" && vrtxImageEditor.save) {
   ...
   if(typeof performSave !== "undefined") {      
     ...
     if(!ok) {
       ...
       EDITOR_ASYNC_SAVING_DEFERRED.rejectWith(this, ["INIT"]);
       return false;
     }
   }
   $("#editor").ajaxSubmit({
     ...
     error: function(xhr, statusText, errMsg) {
       vrtxSimpleDialogs.closeDialog("#dialog-loading");
       EDITOR_ASYNC_SAVING_DEFERRED.rejectWith(this, [errMsg]);
     }
  });
}
