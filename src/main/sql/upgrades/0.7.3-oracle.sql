...
NB: Rapportering! Trolig via python?
...
select 'dup', a.resource_id, r.uri, a.action_type_id, a.is_user, a.user_or_group_name
from acl_entry a, vortex_resource r
WHERE 
...
select 'read_all_delete', ae.resource_id, r.uri, ae.action_type_id, ae.is_user, ae.user_or_group_name
...
select 'read_write_dup', ae.resource_id, r.uri, ae.action_type_id, ae.is_user, ae.user_or_group_name
from acl_entry ae, vortex_resource r
where ae.action_type_id = 1 -- read
and ae.resource_id = r.resource_id
and exists 
