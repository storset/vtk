      ...
      <div class="kupu-toolboxes" id="kupu-toolboxes">
        <div class="kupu-toolbox" id="kupu-toolbox-properties">
          ...
          <div>
            ...
            <span class="vortikal-kupu-link">Testintegrasjon av <a target="new_window" href="http://kupu.oscom.org/">Kupu</a>, ta <a target="new_window" href="http://www.usit.uio.no/it/vortex/hjelp/admin/kupu/">forholdsregler!</a></span>
