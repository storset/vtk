...
public class DisplayXmlResourceControllerTestCase extends MockObjectTestCase {
    ...
    public void testLastModified() {
        ...
        schemaProperty.setValue(faqSchema);

        Date lastModifiedExpected = new Date();
        Mock mockResource = mock(Resource.class, "mockResource");
        ...
        mockResource.expects(atLeastOnce()).method("getName").withNoArguments().will(
                returnValue("test resource"));
