...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript" src="${webResources?html}/jquery/plugins/jquery-ui-1.8.8.custom/js/jquery-ui-1.8.8.custom.min.js"></script>
    <script type="text/javascript" src="${webResources?html}/jquery/plugins/jquery-ui-1.8.8.custom/js/jquery.ui.datepicker-no.js"></script>
    <script type="text/javascript" src="${webResources?html}/jquery/plugins/jquery-ui-1.8.8.custom/js/jquery.ui.datepicker-nn.js"></script>
    ...
    <link type="text/css" href="${webResources?html}/jquery/plugins/jquery-ui-1.8.8.custom/css/smoothness/jquery-ui-1.8.8.custom.css" rel="stylesheet" />
    <#if cssURLs?exists>
