$(document).ready(function () {
  $(".vrtx-shared-text input").each(function () {
    ...
    $.getJSON(path, function (data) {
      ...
      $(inputfieldContainer).html("<div class='shared-text-error'><span class='shared-text-error-message'>Kunne ikke laste fellestekst!</span><span class='shared-text-error-uri'>" + path + "</span></div>")
    });
  });
