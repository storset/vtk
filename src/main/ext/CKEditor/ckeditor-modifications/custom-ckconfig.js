...
config.toolbar_Complete = [
            ...
            ['Format','-','Bold','Italic','Strike','Subscript','Superscript','NumberedList','BulletedList','Outdent','Indent','JustifyLeft','JustifyCenter','JustifyRight','TextColor','Maximize']
] ;
...
config.toolbar_Inline = [
            ['Source','PasteText','PasteFromWord','Link','Unlink', 'Bold','Italic','Strike','Subscript','Superscript','SpecialChar']
] ;

config.toolbar_Inline_S = [
            ['Source','PasteText','PasteFromWord','Link','Unlink', 'Bold','Italic','Strike','SpecialChar']
] ;
...
config.toolbar_AddComment = [
            ['Source', 'Bold','Italic','Strike','NumberedList','BulletedList','Link','Unlink']
] ;
};
