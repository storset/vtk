...
GRANT DELETE, SELECT, INSERT, UPDATE ON acl_entry, acl_entry_seq_pk, action_type, changelog_entry, changelog_entry_seq_pk, extra_prop_entry, extra_prop_entry_seq_pk, lock_type, prop_type, vortex_lock, vortex_lock_seq_pk, vortex_resource, vortex_resource_seq_pk, vortex_tmp_session_id_seq, vortex_tmp TO vrtx;
