...
package org.osmf.player.configuration
{
	...
	{	
		...
		{
			pluginConfigurations = new Vector.<MediaResourceBase>();
		}
		...
		private var configurationFlashvarsDeserializer:ConfigurationFlashvarsDeserializer = new ConfigurationFlashvarsDeserializer();
