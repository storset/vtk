...
import org.vortikal.index.observation.ResourceChangeNotifier;
...
public class ResourceChangeObserverImpl implements BeanNameAware,
    ...
    /**
     * @see org.vortikal.index.observation.ResourceChangeObserver#disable()
     */
    ...
    /**
     * @see org.vortikal.index.observation.ResourceChangeObserver#enable()
     */
    ...
    /**
     * @see org.vortikal.index.observation.ResourceChangeObserver#isEnabled()
     */
