...
<div class="vrtx-feedback">
  <span class="vrtx-feedback-title">
    ...
    <ul>
      <li>
        <a class="feedback-yes thickbox" title='<@vrtx.msg code="feedback.title" default="Give feedback" />' href="${link?html}&amp;like=true&amp;height=390&amp;width=345">
          <@vrtx.msg code="feedback.link.yes" default="Yes I found it" />
        </a>
      </li>
      <li>
        <a class="feedback-no thickbox" title='<@vrtx.msg code="feedback.title" default="Give feedback" />' href="${link?html}&amp;like=false&amp;height=390&amp;width=345">
